...
export default function Landing() {
  ...
  return (
    <div className=" mx-auto h-screen flex flex-col items-center justify-center text-center gap-12 text-primary p-6 ">
